...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("hyprpolkitagent || /usr/lib/polkit-kde-authentication-agent-1 || /usr/libexec/polkit-kde-authentication-agent-1 || /usr/lib/hyprpolkitagent || /usr/libexec/hyprpolkitagent")
end)
