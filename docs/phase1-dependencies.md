...
| Qt widget style | `gruvbox-kvantum` | Exact approved local payload under `themes/kvantum/gruvbox-kvantum/` and active selector in Qt/Kvantum configuration | Included for local/fresh-VM testing by owner approval; public redistribution remains blocked pending license review. |
